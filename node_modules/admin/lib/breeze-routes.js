...
(function(routes){
    ...
    function configureRoutes(app) {
        app.get( '/shopping/Lookups',     getLookups   ); // demo specialized route
        app.get( '/shopping/Metadata',    getMetadata  );
        app.post('/shopping/SaveChanges', saveChanges  );

        // '/breeze/zza/:resource' must be the last breeze/zza API route
        app.get( '/shopping/zza/:resource',       getQuery);
    }
