...
module.exports = function ( app, passport, db ) {
    ...
    var debug = __dirname + '/../public/admin';
    app.use(fileServer(__dirname + '/../../public/admin')); // was fileServer( process.cwd() )

    function bootstrapModels() {
        // Bootstrap models
        var appPath = process.cwd();
        require(appPath + '/server/config/util').walk(appPath + '/node_modules/admin/lib/models', null, function (path) {
            require(path);
        });
    }
