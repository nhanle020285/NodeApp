    ...
    function configureStates($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            .state('app',
            {
                ...
                views: {
                    'header': {
                        templateUrl: 'public/shoppingcart/app/shell/header.html'
                    },
                    'content': {
                        templateUrl: 'public/shoppingcart/app/shell/home.html'
                    },
                    'footer': {
                        templateUrl: 'public/shoppingcart/app/shell/footer.html'
                    }
                }
            })
                .state( 'app.home',
                ...
                .state( 'app.about',
                {
                    ...
                    views : {
                        'content@' : {
                            templateUrl: 'public/shoppingcart/app/shell/about.html'
                        }
                    }
                })
                .state( 'app.order',
                {
                    ...
                    views : {
                        'content@' : {
                            templateUrl: 'public/shoppingcart/app/order/order.html'
                        },
                        'orderSidebar@app.order' : {
                            templateUrl: 'public/shoppingcart/app/order/orderSidebar.html'
                        },
                        'content@app.order' : {
                    ...
                    .state( 'app.order.item',
                    {
                        ...
                        views : {
                            'content@app.order' : {
                                templateUrl : 'public/shoppingcart/app/order/orderItem.html'
                            }
                        }
                    })
                    ...
                    .state( 'app.order.cart',
                    {
                        ...
                        views : {
                            'content@app.order' : {
                                templateUrl : 'public/shoppingcart/app/order/cart.html'
                            }
                        }
                    })
                ...
                .state( 'app.menu',
                {
                    ...
                    views : {
                        'content@' : {
                            templateUrl: 'public/shoppingcart/app/menu/menu.html'
                        },
                ...
                .state( 'app.customer',
                {
                    ...
                    views : {
                        'content@' : {
                            templateUrl: 'public/shoppingcart/app/customer/customer.html'
                        },
                        'orderSidebar@app.menu' : {
                            templateUrl: 'public/shoppingcart/app/order/orderSidebar.html'
                        }
